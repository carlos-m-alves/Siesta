...
<c:choose>
 <c:when test="${! empty logado}">  
  ...
  <div class="site-wrap">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              <h1 class="text-white font-weight-bold">Atualizar Informações Parceiro</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <form id="formAddParc" > 
        <input id="parceiroIdServ" name="parceiroIdServ" value="${parceiro.id}" type="text" style="visibility: hidden">
        <input id="nomeServ" name="nomeServ" type="text" style="visibility: hidden">
        <input id="cpfServ" name="cpfServ" type="text" style="visibility: hidden">
        <input id="dataNascServ" name="dataNascServ" type="text" style="visibility: hidden">
    </form>
      ...
      <div class="container">
        <div class="row" align="center" >
          ...
          <div class="col-lg-5 col-sm-5 blog-content" >            
            <input id="nome" type="text" class="form-control form-control-lg" value="${parceiro.nome}"
        ...
        <div class="row" align="center" >
          ...
          <div class="col-lg-5 col-sm-5 blog-content" >            
            ...
            <input value="${parceiro.cpf}"  maxlength="14"
                   placeholder="" id="cpf" name="cpf" type="text" class="form-control form-control-lg" 
        ...
        <div class="row" align="center" >
          ...
          <div class="col-lg-5 col-sm-5 blog-content" > 
            <input placeholder="12/12/1992" value="${parceiro.datanascimento}"
        ...
        <div class="row" align="center" >
          ...
          <div class="col-lg-5 col-sm-5 blog-content" >            
            <input placeholder="" id="email" disabled type="email" class="form-control form-control-lg" value="${parceiro.email}"
                   style="text-align: center;">      
          </div>
        </div>        
...
<!--    </form> -->
  ...
  <!-- LIB FIREBASE -->
    ...
    <script>
      ...
      async function atualizar(email, senha){
        mostraModal("Carregando...","WAIT");            
        
        document.getElementById("formAddParc").action="./AdministradorServlet?action=edtParceiro";
        document.getElementById("formAddParc").method = "POST";
        //document.getElementById("formAddParc").parceiroServ.value = document.getElementById('parceiroServ').value;
