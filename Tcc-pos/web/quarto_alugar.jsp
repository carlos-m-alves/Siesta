        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">                
                <input class="form-control form-control-lg" type="date" name="dataReserva" id="dataReserva" min="2019-09-01" max="2020-12-31" />
              </ul>
            </div>
            ...
            <div class="bg-light p-3 border rounded mb-4">
              <h3 class="text-primary  mt-3 h5 pl-3 mb-3 ">
                ...
                <div class="px-3" style="clear:both">
                 ...
                 ${avaliacao.quantidade == 1 ? 'Avaliação' : avaliacao.quantidade > 1 ? 'Avaliações' : 'Sem Avaliação'}
                </div>
            </div>
            ...
            <br />    
            <div class="bg-light p-3 border rounded">
              <h3 class="text-primary  mt-3 h5 pl-3 mb-3 ">Confirmar</h3>                        
              <div class="col-6">
                <a onclick="mostraModal('Gostaria de confirmar a reserva?', 'CONFIRME')" class="btn btn-block btn-primary btn-md">Reservar</a>
              </div>
            </div>    
            ...
            <div id="open-modal" class="modal-window">
              <div>
                ...
                <a id="modalTagConfirme" onClick="enviaFormReservar(0,0)"  class="btn btn-block btn-primary btn-md">Confirme</a>
              </div>
            </div>    
            <!-- MODAL -->
...
<script>
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                $.each(data, function(i, obj){
                    listaHora.push(obj.idHrChegada);
                });
                ...
                for (i = 1; i < 9; i++) {
                    ...
                    for (j = 0; j < listaHora.length; j++) {
                        //console.log("j: "+j+" . i: "+i+" . Tamanho lista: "+listaHora.length);
                        //console.log("listaHora: "+listaHora[j]);
                        if( i == listaHora[j] ){
                            cadastrado = 0;
                            break;
                        }
                    ...
                    if( cadastrado == 1 ){
                        //$("#horarios").append('<option value='+i+ '>'+i+'</option>');
                        switch (i) {
                            case 1:
                              $("#horarios").append('<option value='+i+ '>11:00 DISPONÍVEL</option>');
                              break;
                            case 2:
                              $("#horarios").append('<option value='+i+ '>11:30 DISPONÍVEL</option>');
                              break;
                            case 3:
                              $("#horarios").append('<option value='+i+ '>12:00 DISPONÍVEL</option>');
                              break;
                            case 4:
                              $("#horarios").append('<option value='+i+ '>12:30 DISPONÍVEL</option>');
                              break;
                            case 5:
                              $("#horarios").append('<option value='+i+ '>13:00 DISPONÍVEL</option>');
                              break;
                            case 6:
                              $("#horarios").append('<option value='+i+ '>13:30 DISPONÍVEL</option>');
                              break;
                            case 7:
                              $("#horarios").append('<option value='+i+ '>14:00 DISPONÍVEL</option>');
                              break;
                            case 8:
                              $("#horarios").append('<option value='+i+ '>14:30 DISPONÍVEL</option>');
                              break;
                            default:
                              break;
                          }
                ...
                if( data == '' ){                    
                    //console.log("eh nulo");
                    //criar elementos com link e popup para confirmar
                }
            },
    ...
    function chamaConfirmacao(i){
        console.log('criar popup para confirmar: '+i);
    }
    ...
    function mostraModal(msg, func){            
        ...
        if( func == 'WAIT'){
            ...
            document.getElementById("modalTagH").innerText = 'Confirme';  
    ...
    function enviaFormReservar(idHorario, idQuarto){
        ...
        //alert('valor no input: '+document.getElementById("horarios").value);
        ...
        if( document.getElementById("horarios").value == "" ){
            //console.log("Escolha uma data.")    
            mostraModal("Escolha um horário.",10)
            return;
        }
        
        document.getElementById("formReserva").action="./ReservaServlet?action=reserva";
        document.getElementById("formReserva").method = "POST";
        document.getElementById("formReserva").idHorario.value = document.getElementById("horarios").value;
        document.getElementById("formReserva").idQuarto.value = ${quarto.id};
