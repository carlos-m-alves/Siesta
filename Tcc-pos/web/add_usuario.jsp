 ...
 <c:when test="${empty logado}">  
  ...
  <div class="site-wrap">
        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              <li><a href="index.jsp" class=" nav-link">Página inicial</a></li>
            </ul>
          </nav>
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              <h1 class="text-white font-weight-bold">Cadastrar novo usuário</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <form id="formAddUsu" > 
        ...
        <input id="senhaServ" name="senhaServ" type="text" style="visibility: hidden">
        <input id="confSenhaServ" name="confSenhaServ" type="text" style="visibility: hidden">
    </form>
    <section class="site-section">
      <div class="container">
        ...
        <div class="row" align="center" >
          ...
          <div class="col-lg-5 col-sm-5 blog-content" >            
            <input placeholder="12/12/1992" 
                   id="dataNasc" type="date" class="form-control form-control-lg" min="1950-01-01" max="2019-08-31"
                   style="text-align: center;">      
          </div>
        </div>
        <div class="row" align="center" >
        ...
        <div class="row" align="center" >
            <div align="right"class="col-lg-4 col-sm-4 blog-content" >
                <p style="font-size:24px">Senha</p>  
            </div>  
          <div class="col-lg-5 col-sm-5 blog-content" >            
            <input placeholder="" id="senha" type="password" class="form-control form-control-lg" required
                   style="text-align: center;">      
          </div>
        </div> 
        <div class="row" align="center" >
            <div align="right"class="col-lg-4 col-sm-4 blog-content" >
                <p style="font-size:24px">Confirme</p>  
            </div>  
          <div class="col-lg-5 col-sm-5 blog-content" >            
            <input placeholder="" id="confirme" type="password" class="form-control form-control-lg" required
                   style="text-align: center;">      
          </div>
        </div>   
    ...
    <script>
        ...
        btnSubmit.addEventListener('click', function (){
            ...
            if( senha.value.length <= 0 ){
                mostraModal("Preencha o campo SENHA.",0);                
                return;
            }
            if( confirme.value.length <= 0 ){
                mostraModal("Preencha o campo CONFIRME A SENHA.",0);                
                return;
            }
            if( confirme.value != senha.value ){
                mostraModal("Os campos de senha não conferem.",0);                
                return;
            }
      ...
      function qlqCOisa(){
        //alert('printa algo');
        //chama servlet
        document.getElementById("formAddUsu").action="./AdministradorServlet?action=insereUsu";
        document.getElementById("formAddUsu").method = "POST";
        document.getElementById("formAddUsu").nomeServ.value = document.getElementById('nome').value;
        document.getElementById("formAddUsu").cpfServ.value = document.getElementById('cpf').value;
        document.getElementById("formAddUsu").dataNascServ.value = document.getElementById('dataNasc').value;
        document.getElementById("formAddUsu").emailServ.value = document.getElementById('email').value;
        document.getElementById("formAddUsu").senhaServ.value = document.getElementById('senha').value;
        document.getElementById("formAddUsu").confSenhaServ.value = document.getElementById('confirme').value;

        document.getElementById("formAddUsu").submit();           
      }    
          
          
      function resolverDepoisDe10Segundos(nome, cpf, dataNasc, email, senha, confirme) {
        return new Promise(resolve => {
          setTimeout(() => {
              ...
              //chama servlet
              document.getElementById("formAddUsu").action="./AdministradorServlet?action=insereParc";
              document.getElementById("formAddUsu").method = "POST";
              document.getElementById("formAddUsu").nomeServ.value = nome;
              document.getElementById("formAddUsu").cpfServ.value = cpf;
              document.getElementById("formAddUsu").dataNascServ.value = dataNasc;
              document.getElementById("formAddUsu").emailServ.value = email;
              document.getElementById("formAddUsu").senhaServ.value = senha;
              document.getElementById("formAddUsu").confSenhaServ.value = confirme;
