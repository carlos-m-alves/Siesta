  ...
  <div class="site-wrap">
    ...
    <section class="site-section">
      <div class="container">
        ...
        <form action="UsuarioServlet?action=pesquisaBairro" method="POST">
            <div class="row mb-5 justify-content-center">
              ...
              <div class="col-md-7 ">            
                  <div class="col-lg-5 col-sm-5 blog-content" >            
                    <input id="bairro" name="bairro" type="text" class="form-control form-control-lg"/>     
                  </div>
              </div>
              <div class="col-md-2">
                <button type="submit" class="btn btn-block btn-primary btn-md">Pesquisar</button>
              </div>
            </div>
        </form>
        ...
        <div class="mb-5">
            ...
            <c:forEach var="hospedagem" items="${listaHospedagens}">   
                <div class="text-center row align-items-start job-item border-bottom pb-3 mb-3 pt-3">
                  <div class="col-md-2">
                    <a href="UsuarioServlet?action=infHospedagem&idHospedagem=${hospedagem.id}&recordsPerPage=5&currentPage=1"><img src="images/featured-listing-1.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-md-4">
                    <h2><a href="UsuarioServlet?action=infHospedagem&idHospedagem=${hospedagem.id}&recordsPerPage=5&currentPage=1">${hospedagem.nome}</a> </h2>
          ...
          <div class="col-md-6 text-center text-md-left">
            <div class="custom-pagination ml-auto">
              ...
              <c:if test="${currentPage != 1}">
                <a class="prev" 
                    href="UsuarioServlet?action=pagination&recordsPerPage=${recordsPerPage}&currentPage=${currentPage-1}">
                    Anterior
                </a>
              </c:if>
              ...
              <div class="d-inline-block">
                <c:forEach begin="1" end="${noOfPages}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a class="" 
                                href="UsuarioServlet?action=pagination&recordsPerPage=${recordsPerPage}&currentPage=${i}">${i}</a>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
              </div>  
