        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              <li class="active nav-link"><a href="QuartoServlet?action=pagination&idHospedagem=${Usuario.idHospedagem}&recordsPerPage=5&currentPage=1" class="nav-link">Lista de Quartos</a></li>
            </ul>
          </nav>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row" align="center" >
          ...
          <div class="col-lg-5 col-sm-5 blog-content" >            
            <textarea id="descricao" name="descricao" maxlength="255" name="textarea" style="width:445px;height:150px;resize: none;"></textarea>
          </div>
        </div>  
        <div class="row" align="center" >
            <div align="right"class="col-lg-4 col-sm-4 blog-content" >
...
<!--    </form> -->
  ...
  <!-- LIB FIREBASE -->
    ...
    <script>
        ...
        //chama servlet      
        resolverDepoisDe40Segundos(nomeQuarto.value, descricao.value, preco.value, adicionais, nomeUid);                
      });    
          
      function resolverDepoisDe40Segundos(nomeQuarto, descricao, preco, adicionais, nomeUid) {
