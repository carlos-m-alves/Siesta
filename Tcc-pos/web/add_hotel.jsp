 ...
 <c:when test="${! empty logado}">  
  ...
  <div class="site-wrap">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              <h1 class="text-white font-weight-bold">Adicionar Hospedagem</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <form id="formAddHotel" > 
        <input id="parceiroServ" name="parceiroServ" type="text" style="visibility: hidden">
      ...
      <div class="container">
        <div class="row" align="center" >
            <div align="right"class="col-lg-4 col-sm-4 blog-content" >
                <p style="font-size:24px">Parceiro</p>  
            </div>  
            <div class="col-lg-5 col-sm-5 blog-content">
                <select id="parceiro" class="form-control form-control-lg" style="align-content:center">
                    <option value="${selected}" selected>${selected}</option>
                    <c:forEach items="${listaParceiros}" var="parceiro">
        ...
        <div class="row" align="center" >
            <div align="right"class="col-lg-4 col-sm-4 blog-content" >
                <p style="font-size:24px">Nome Hospedagem</p>
            </div>  
          <div class="col-lg-5 col-sm-5 blog-content" >            
        ...
        <div class="row" align="center" >
            ...
            <div class="col-lg-5 col-sm-5 blog-content">
                <select id="bairro" class="form-control form-control-lg" style="align-content:center">
                    <option value="${selected}" selected>${selected}</option>
        ...
        <div class="row" align="center" >
          ...
          <div class="col-lg-5 col-sm-5 blog-content" >            
            <input maxlength="100" placeholder="" id="numero" type="text" class="form-control form-control-lg"
                   style="text-align: center;" onkeypress='return SomenteNumero(event)'>      
          </div>
        </div>   
        <div class="row" align="center" >
            <div align="right"class="col-lg-4 col-sm-4 blog-content" >
        ...
        <div class="row" align="center" >
          ...
          <div class="col-lg-5 col-sm-5 blog-content" >            
            <input onkeypress="return mask(event, this, '#####-###')"  maxlength="9" placeholder="99999-999" 
                   id="cep" type="text" class="form-control form-control-lg"
                   style="text-align: center;">      
          </div>
        </div>                  
  ...
  <script src="js/custom.js"></script>
    ...
    <script>
        ...
        btnSubmit.addEventListener('click', function (){
            ...
            var idParceiro = parceiro.options[parceiro.selectedIndex].value;     
            
            if( idParceiro <= 0 ){               
                mostraModal("Escolha um PARCEIRO.",0);                
                return;
            }    
            ...
            //    mostraModal("Preencha o campo COMPLEMENTO.",0);                
            //    return;
            //}
            ...
            ///////////////////////////////////////////////
            //chama servlet
            document.getElementById("formAddHotel").action="./AdministradorServlet?action=insereHotel";
            document.getElementById("formAddHotel").method = "POST";
            document.getElementById("formAddHotel").parceiroServ.value = idParceiro;
